...
// ];
// const ob = users.map(num => num.name)
// console.log(ob)
...
// const r = arr.map(num=>num)

// console.log(resul)
// console.log(resull)
// console.log(r)

// const namee = "abdullah AL mamun"
// const reversee = namee.split("").reverse().join("")
// console.log(reversee)
// console.log(namee.length)
// console.log(namee.charAt(0).toUpperCase() + namee.slice(1))
